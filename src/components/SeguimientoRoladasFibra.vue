...
const cargarDatos = async () => {
  ...
  try {
    ...
    const urlRoladas = `${API_BASE}/seguimiento-roladas-fibra?fechaInicio=${fechaInicio.value}&fechaFin=${fechaFin.value}`
    ...
    const urlEstadisticas = `${API_BASE}/hvi-estadisticas-mezcla?fechaInicio=${fechaInicio.value}&fechaFin=${fechaFin.value}`
...
const cargarDatosMistura = async (mistura) => {
  ...
  try {
    const url = `${API_BASE}/calidad-fibra-mistura?mistura=${mistura}`
